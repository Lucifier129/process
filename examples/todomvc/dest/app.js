...
/***/ function(module, exports, __webpack_require__) {
	...
	var MobileSafariClickEventPlugin = __webpack_require__(173);
	...
	var ReactDOMImg = __webpack_require__(182);
	var ReactDOMIDOperations = __webpack_require__(112);
	var ReactDOMIframe = __webpack_require__(183);
	...
	var createFullPageComponent = __webpack_require__(213);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(108);
	var ReactDefaultPerfAnalysis = __webpack_require__(215);
	var ReactMount = __webpack_require__(131);
	var ReactPerf = __webpack_require__(92);
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement('input', { id: 'toggle-all', type: 'checkbox', onChange: function (e) {
							return process.resolve('toggleAll', e.currentTarget.checked);
					...
					_react2['default'].createElement(_todos2['default'], { todos: todos, process: process })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = (function (_Component) {
		...
		_createClass(Todo, [{
			...
			key: 'handleBlur',
			value: function handleBlur(e) {
				var newTitle = e.currentTarget.value.trim();
				this.setState({
					onEdit: false
				});
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'a',
								{ href: '#/', className: this.getClassName('#/') },
								'All'
							)
						),
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'a',
								{ href: '#/active', className: this.getClassName('#/active') },
								'Active'
							)
						),
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'a',
								{ href: '#/completed', className: this.getClassName('#/completed') },
								'Completed'
							)
						)
					),
					_react2['default'].createElement(
						'button',
						{ id: 'clear-completed', onClick: process.willResolve('clearCompleted') },
